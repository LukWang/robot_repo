...
if("TRUE" STREQUAL "TRUE")
  set(robot_localization_SOURCE_PREFIX /home/luk/catkin_ws/src/robot_collaboration/robot_localization)
  set(robot_localization_DEVEL_PREFIX /home/luk/catkin_ws/src/robot_collaboration/robot_localization/build/devel)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'robot_localization' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'luk <luk@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'robot_localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/luk/catkin_ws/src/robot_collaboration/robot_localization/${idir}'.  Ask the maintainer 'luk <luk@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/luk/catkin_ws/src/robot_collaboration/robot_localization/build/devel/lib;/home/luk/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
